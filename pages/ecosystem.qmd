...
| **2. Native-grid I/O** | loaders that return pixels in native CRS, no resampling; sits atop a deep I/O stack (filesystem, codecs, readers, xarray backends) | rasteret, virtual-tiff · see [I/O & Storage Stack](io-stack.qmd) |
...
| **Legacy TIFFs** → Zarr-native workflow | Zarr view | `virtual-tiff` | zero-copy virtualization |
