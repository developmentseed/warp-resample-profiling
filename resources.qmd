...
```{=html}
<iframe width="780" height="500" src="https://link.excalidraw.com/readonly/GgF1qYswczuP9WKpoCvU" title="Resampling overview diagram"></iframe>
```

```{=html}
<iframe width="780" height="500" src="https://link.excalidraw.com/readonly/xuI4bOWknGiz4y4TeuHj" title="Resampling algorithms"></iframe>
```

### Posters

- [Fast and scalable general geospatial regridding by Justus Magin](https://zenodo.org/records/17297950)
...
- [DGGS regridding](https://iaocea.github.io/regridding-ecosystem-overview/intro.html)
